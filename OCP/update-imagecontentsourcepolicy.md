...
# Test the file using both registries first
podman pull --authfile pull-secret quay-public.sandbox1829.opentlc.com/openshift/openshift/release-images:4.11.38-x86_64
